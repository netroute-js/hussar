...
public class MongoDBAssertionHelper {
    ...
    public static void assertMongoDBBootstrapped(@NonNull MongoDBDockerService mongoDBService,
        ...
        assertPropertyConfigured(MONGODB_URL_PROPERTY, endpoint.address(), applicationClient);
        assertPropertyConfigured(MONGODB_ALTERNATIVE_URL_PROPERTY, endpoint.address(), applicationClient);
        assertPropertyConfigured(MONGODB_USERNAME_PROPERTY, credentials.username(), applicationClient);
        assertPropertyConfigured(MONGODB_ALTERNATIVE_USERNAME_PROPERTY, credentials.username(), applicationClient);
        assertPropertyConfigured(MONGODB_PASSWORD_PROPERTY, credentials.password(), applicationClient);
        assertPropertyConfigured(MONGODB_ALTERNATIVE_PASSWORD_PROPERTY, credentials.password(), applicationClient);
    }
