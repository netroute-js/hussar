...
import pl.netroute.hussar.service.nosql.kafka.assertion.KafkaAssertionHelper;
import pl.netroute.hussar.service.nosql.kafka.helper.KafkaSenderFactory;
...
public class KafkaDockerServiceIT {
    ...
    public void shouldStartExtendedKafkaService() {
        ...
        var partitions = 5;
        var topicA = new Topic("topicA", partitions);
        var topicB = new Topic("topicB", partitions);
    ...
    public void shouldAutoCreateTopic() {
        ...
        var partitions = 1;
        var topic = new Topic("topic", partitions);
