package pl.netroute.hussar.service.nosql.kafka.assertion;
...
import pl.netroute.hussar.service.nosql.kafka.KafkaDockerService;
...
public class KafkaAssertionHelper {
    ...
    public void assertTopicsCreated(@NonNull List<Topic> topics) {
        var endpoint = EndpointHelper.getAnyEndpointOrFail(kafka);
