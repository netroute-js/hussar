package pl.netroute.hussar.service.nosql.assertion;
...
public class MongoDBAssertionHelper {
    ...
    public void assertRegisteredEndpointUnderProperty(@NonNull String registeredProperty) {
        ...
        assertRegisteredEntryInConfigRegistry(registeredProperty, endpoint.getAddress(), PropertyConfigurationEntry.class);
    }

    public void assertRegisteredEndpointUnderEnvironmentVariable(@NonNull String registeredEnvVariable) {
        var endpoint = EndpointHelper.getAnyEndpointOrFail(database);

        assertRegisteredEntryInConfigRegistry(registeredEnvVariable, endpoint.getAddress(), EnvVariableConfigurationEntry.class);
    }
    ...
    private MongoClient createClient(Endpoint endpoint) {
        var mongoURL = new ConnectionString(endpoint.getAddress());
